...
export default function SaasUserDropdown() {
  const [isOpen, setIsOpen] = useState(false);
  const [userEmail, setUserEmail] = useState("SaaS Admin");
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 flex h-11 w-11 items-center justify-center rounded-full bg-red-600 text-white font-bold text-lg shadow-md">
      ...
      >
        <div>
          ...
          <span className="mt-0.5 block text-theme-xs text-red-500 font-medium">
            Super Administrador
          </span>
